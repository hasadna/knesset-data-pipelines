...
from .exceptions import ReachedMaxRetries, InvalidStatusCodeException
from . import config
...
def get_retry_response_content(url, params, timeout, proxies, retry_num, num_retries, seconds_between_retries,
    ...
    if config.DATASERVICE_HTTP_PROXY:
        proxies["https"] = proxies["http"] = config.DATASERVICE_HTTP_PROXY
